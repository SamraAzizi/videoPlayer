...
const Image = props => {
  ...
  if (unoptimized) {
    return React__default["default"].createElement(NextImage__default["default"], Object.assign({
      unoptimized: true
    }, nonIKParams, {
      src: javascript.buildSrc({
        urlEndpoint,
        src,
        queryParameters,
        transformationPosition,
  ...
  const finalSrcWithoutTransformation = javascript.buildSrc({
    urlEndpoint,
    queryParameters,
    src
  });
  return (
    // Always keep src in the end
    React__default["default"].createElement(NextImage__default["default"], Object.assign({
      loader: ({
        src,
        width
      }) => {
...
const Video = React.forwardRef((props, ref) => {
  ...
  return React__default["default"].createElement("video", Object.assign({
    ref: ref
  }, nonIKParams, {
    src: finalSrc
  }));
